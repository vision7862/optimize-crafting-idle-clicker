...
export const MWS_LOYALTY_ACHIEVE_MERCHANT_MULTIPLIER = 12;

export const MAIN_WORKSHOP_MERCHANT_CAPACITY = 16;

export const RESEARCH_ACHIEVEMENT_MULTIPLIER = 15;
export const TOTAL_BLUEPRINT_SCORE_MULTIPLIER = 4.5;
