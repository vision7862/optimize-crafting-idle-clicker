...
export const BLUEPRINT_LIBRARY: Blueprint[] = [
  ...
  { productName: 'Bronze Ingots', evolutionStage: 3, upgradeLevel: 1, score: 600, scoreChangePerLevel: 60 },
  { productName: 'Bronze Spear', evolutionStage: 3, upgradeLevel: 1, score: 600, scoreChangePerLevel: 60 },
  { ...s21.b2, productName: 'Bronze Shield' },
  { ...s21.b3, productName: 'Bronze Blades' },
  { ...s21.b3, productName: 'Bronze Dagger' },
  ...
  { ...s21.b4, productName: 'Iron Ingots', score: 5400, scoreChangePerLevel: 540 },
