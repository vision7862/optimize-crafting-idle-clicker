...
const s21 = {
  ...
  t4: { ...BASE_BP, evolutionStage: 4, upgradeLevel: 51, score: 28800, scoreChangePerLevel: 480 },
};
...
const s51 = {
  ...
  b5: { ...BASE_BP, evolutionStage: 5, score: 483840, scoreChangePerLevel: 48384 },
};
...
// strategy 81+10
const s81 = {
  b2: { ...BASE_BP, evolutionStage: 2, score: 180, scoreChangePerLevel: 18 },
  b3: { ...BASE_BP, evolutionStage: 3, score: 1800, scoreChangePerLevel: 180 },
  b4: { ...BASE_BP, evolutionStage: 4, score: 19800, scoreChangePerLevel: 1980 },
};

export const BLUEPRINT_LIBRARY: Blueprint[] = [
  { ...s51.b5, productName: 'Wood' },
  { ...s21.b4, productName: 'Club', upgradeLevel: 41, score: 24000 },
  { ...s21.b4, productName: 'Arrows', upgradeLevel: 41, score: 21000, scoreChangePerLevel: 420 },
  { ...s21.b4, productName: 'Bow', upgradeLevel: 41, score: 24000 },
  { ...s51.b4, productName: 'Rawhide', upgradeLevel: 81, score: 241920 },
  { ...s51.b4, productName: 'Leather', upgradeLevel: 41, score: 134400 },
  { ...s21.t4, productName: 'Boots' },
  { ...s21.t4, productName: 'Hilt' },
  { ...s21.t4, productName: 'Leather Armor' },
  { ...s51.b4, productName: 'Copper Ore', upgradeLevel: 61, score: 188160 },
  { ...s21.b4, productName: 'Copper Ingots', upgradeLevel: 51, score: 43200, scoreChangePerLevel: 720 },
  { productName: 'Copper Axe', evolutionStage: 4, upgradeLevel: 51, score: 37800, scoreChangePerLevel: 630 },
  { ...s21.t4, productName: 'Copper Blades' },
  { ...s21.t4, productName: 'Copper Knife' },
  { ...s21.b4, productName: 'Copper Dagger', upgradeLevel: 51, score: 30000, scoreChangePerLevel: 500 },
  { ...s51.b4, productName: 'Tin Ore', upgradeLevel: 71, score: 215040 },
  { ...s21.b4, productName: 'Bronze Ingots', upgradeLevel: 51, score: 38880, scoreChangePerLevel: 648 },
  { ...s21.b4, productName: 'Bronze Spear', upgradeLevel: 51, score: 32400, scoreChangePerLevel: 540 },
  { ...s21.t4, productName: 'Bronze Shield' },
  { ...s21.t4, productName: 'Bronze Blades' },
  { ...s21.t4, productName: 'Bronze Dagger' },
  { ...s21.b4, productName: 'Bronze Sword', upgradeLevel: 41, score: 24000 },
  { ...s51.b4, productName: 'Coal', upgradeLevel: 11, score: 53760 },
  { ...s21.b4, productName: 'Iron Ore', upgradeLevel: 51, score: 39600, scoreChangePerLevel: 660 },
  { ...s21.b4, productName: 'Iron Ingots', upgradeLevel: 51, score: 32400, scoreChangePerLevel: 540 },
  { ...BASE_BP, productName: 'Chisel', upgradeLevel: 41, score: 50 },
  { ...s21.t4, productName: 'Iron Mace' },
  { ...s21.b4, productName: 'Iron Rivets', upgradeLevel: 51, score: 26100, scoreChangePerLevel: 435 },
  { ...BASE_BP, productName: 'Shovel', upgradeLevel: 41, score: 50 },
  { ...s51.b2, productName: 'Lump Hammer', upgradeLevel: 61, score: 840 },
  { ...s21.t4, productName: 'Iron Helmet' },
  { ...s21.t4, productName: 'Iron Plates' },
  { ...s21.b4, productName: 'Imp. Leather Armor', upgradeLevel: 51, score: 32400, scoreChangePerLevel: 540 },
  { ...s21.b4, productName: 'Iron Blades', upgradeLevel: 41, score: 24000 },
  { ...s21.b4, productName: 'Iron Sword', upgradeLevel: 41, score: 25000, scoreChangePerLevel: 500 },
  { ...s21.b4, productName: 'Iron Armor', upgradeLevel: 41, score: 24000 },
  { ...s21.b4, productName: 'Iron Claymore', upgradeLevel: 41, score: 25000, scoreChangePerLevel: 500 },
  { ...s51.b4, productName: 'Gold Ore', upgradeLevel: 81, score: 241920 },
  { ...s51.b2, productName: 'Gold Ingots', upgradeLevel: 51, score: 720 },
  { ...BASE_BP, productName: 'Uncut Emerald' },
  { ...BASE_BP, productName: 'Gold Ring', upgradeLevel: 51, score: 60 },
  { ...BASE_BP, productName: 'Cut Emerald' },
  { ...BASE_BP, productName: 'Gold Necklace', upgradeLevel: 21, score: 30 },
  { ...BASE_BP, productName: 'Emerald Ring' },
  { ...BASE_BP, productName: 'Uncut Ruby', upgradeLevel: 11, score: 20 },
  ...
  { ...BASE_BP, productName: 'Uncut Sapphire', upgradeLevel: 41, score: 50 },
  ...
  { ...s51.b2, productName: 'Cut Sapphire', upgradeLevel: 51, score: 720 },
  { ...BASE_BP, productName: 'Halberd' },
  { ...s51.b2, productName: 'Microscope', upgradeLevel: 61, score: 840 },
  { ...s71.b2, productName: 'Compass', upgradeLevel: 61, score: 1120 },
  ...
  { ...s51.b2, productName: 'Saltpeter', upgradeLevel: 61, score: 840 },
  { ...s71.b2, productName: 'Gunpowder', upgradeLevel: 41, score: 800 },
  ...
  { ...s51.b2, productName: 'Rocket Launcher', upgradeLevel: 31, score: 480 },
  { ...BASE_BP, productName: 'Telephone', upgradeLevel: 31, score: 40 },
  { ...s51.b2, productName: 'Lever Action Rifle', upgradeLevel: 31, score: 480 },
  ...
  { ...s81.b2, productName: 'Antenna', upgradeLevel: 61, score: 1260 },
  { ...BASE_BP, productName: 'Car', upgradeLevel: 21, score: 30 },
  { ...BASE_BP, productName: 'Radio', upgradeLevel: 21, score: 30 },
  { ...s51.b2, productName: 'Truck', upgradeLevel: 41, score: 600 },
