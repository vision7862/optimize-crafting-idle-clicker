...
export const BLUEPRINT_LIBRARY: Blueprint[] = [
  ...
  { ...s21.b4, productName: 'Copper Blades' },
  { ...s21.b4, productName: 'Copper Knife' },
  ...
  { ...s21.b3, productName: 'Bronze Sword' },
  ...
  { ...s21.b3, productName: 'Iron Helmet' },
  { ...s21.b4, productName: 'Iron Plates' },
  ...
  { ...s21.b3, productName: 'Iron Armor' },
  { ...s21.b3, productName: 'Iron Claymore', score: 520, scoreChangePerLevel: 52 },
...
const BPS_AT_TOP = ['Copper Axe', 'Copper Blades', 'Copper Knife', 'Iron Ingots', 'Iron Plates'];
