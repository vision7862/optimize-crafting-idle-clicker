...
describe('should Upgrade', () => {
  test('should return true when it will take fewer cycles with upgrade', () => {
    ...
    expect(getUpgradedWorkshopIfBetter(7e23, false, false, product.details.name, workshop, 1)).not.toBeNull();
  });
  ...
  test('should return false when it will take more cycles with upgrade', () => {
    ...
    expect(getUpgradedWorkshopIfBetter(7e23, false, false, product.details.name, workshop, 1)).toBeNull();
  });
});
